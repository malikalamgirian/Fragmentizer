...
public class XMLProcessor {
    ...
    public static Document getXMLDocumentForXMLFile(String xml_File_URL) {
        Document doc;
    ...
    public static Document deleteNodeListFromXMLDocument(Document doc, NodeList nodes_To_Delete) throws Exception {
        Element root;

        try {
            root = doc.getDocumentElement();

            while(nodes_To_Delete.getLength() != 0){
                /*
                 * remove ZEROth child
                 */
                 root.removeChild(nodes_To_Delete.item(0));
            ...
            throw new Exception("deleteNodesFromXMLDocument has gotten some problem : "
                    + e + " : " + e.getMessage());
        }
